/**
 * Fichier override mobile — ios/apptel/src/components\ShareLinkMenu.tsx
 * Créé via: npm run mobile:override -- create components\ShareLinkMenu.tsx
 * Ne pas modifier web/app/src/components\ShareLinkMenu.tsx pour ce comportement mobile-only.
 */
...
export function ShareLinkMenu({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[min(100%,22rem)] mx-auto bg-[#12121a] border border-[#2d2d3d] rounded-2xl max-h-[min(80dvh,36rem)] overflow-y-auto">
