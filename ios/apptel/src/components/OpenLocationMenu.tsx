/**
 * Fichier override mobile — ios/apptel/src/components\OpenLocationMenu.tsx
 * Créé via: npm run mobile:override -- create components\OpenLocationMenu.tsx
 * Ne pas modifier web/app/src/components\OpenLocationMenu.tsx pour ce comportement mobile-only.
 */
...
export function OpenLocationMenu({
  ...
  return (
    <div
      className={`fixed inset-0 ${overlayZClass} flex items-center justify-center p-5 ms-modal-overlay bg-black/60 backdrop-blur-sm`}
      role="dialog"
      aria-modal="true"
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[min(100%,22rem)] mx-auto max-h-[min(80dvh,36rem)] overflow-y-auto rounded-2xl ms-modal-panel bg-[#12121a] border border-[#2d2d3d]">
