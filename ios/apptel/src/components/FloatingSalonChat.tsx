/**
 * Fichier override mobile — ios/apptel/src/components\FloatingSalonChat.tsx
 * Créé via: npm run mobile:override -- create components\FloatingSalonChat.tsx
 * Ne pas modifier web/app/src/components\FloatingSalonChat.tsx pour ce comportement mobile-only.
 */
