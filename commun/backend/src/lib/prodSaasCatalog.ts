...
export const PROD_SAAS_CATALOG: ProdSaasCatalogEntry[] = [
  ...
  },
  {
    ...
    note: '@onscen.com — Google Workspace',
...
export const PROD_SAAS_LINK_GROUPS: ProdSaasLinkGroup[] = [
  {
    id: 'onscen',
    links: [
      { label: 'OnScen prod', url: 'https://onscen.com' },
      { label: 'OnScen staging', url: 'https://staging.onscen.com' },
      { label: 'Health prod', url: 'https://onscen.com/health' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Domaine onscen.com', url: 'https://www.ovh.com/manager/', note: 'Registrar OVH' },
    ],
  },
  {
    id: 'streaming',
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Staging DNS (OVH)', url: 'https://www.ovh.com/manager/', note: 'A staging.onscen.com -> 51.159.170.181' },
