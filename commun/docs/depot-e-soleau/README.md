...
4. Renseigner un intitulé, par ex. : *« Description intégrale application OnScen — réseau social musical »*
...
- **Aucune exclusivité** sur la marque « OnScen » ni sur le code
- Complément utile avant consultation CPI / dépôt de marque distinct

## Prochaines étapes recommandées

- Dépôt de **marque « OnScen »** (classes 9, 38, 41, 42) — démarche séparée
