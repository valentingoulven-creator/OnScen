...
| `ONSCEN-PRESENTATION-PRODUIT.html` | Présentation produit interactive (10 slides · promoteur artistes & événements) |
| `ONSCEN-PRESENTATION-PRODUIT.pptx` | Même contenu en PowerPoint (10 slides · compatible Google Slides) |
...
| `../presentations/ONSCEN-PRESENTATION.html` | Présentation produit interactive (13 slides · navigateur) |
| `../presentations/OnScen-Presentation.pptx` | Présentation produit FR (13 slides · screenshots) |
| `../presentations/ONSCEN-PRESENTATION-MAIRIES-BARS.html` | Présentation visuelle mairies & bars (14 slides · carte, globe, reels, musique) |
...
Produit : `ONSCEN-MARKETING-PRESENTATION.pptx` (16 slides, captures `../presentation-screenshots/mobile/`).
...
Produit : `ONSCEN-PREMIUM-DECK.pptx` — palette claire, public mixte (clients/partenaires/investisseurs), sans chiffres financiers projetés. Design system Stripe/Notion : icônes vectorielles, mockups device, cartes à accent violet.
...
```
commun/docs/strategie/ONSCEN-PRESENTATION-PRODUIT.html
```
...
Produit : `ONSCEN-PRESENTATION-PRODUIT.pptx` — 10 slides, dimensions 10×5.625" (Google Slides).
