/**
 * Génère les 10 lettres de soutien OnScen en .docx
...
async function writeLetter(letter) {
  const header = [
    ...
    new Paragraph({
      children: [
        new TextRun({
          text: 'Modèle indicatif — OnScen · getsoundy.com · Remplacer les […] avant envoi.',
          size: 18,
          color: '888888',
        }),
      ],
...
const LETTERS = [
  {
    ...
    lines: [
      '**Objet :** Lettre de soutien au projet OnScen',
      '',
      'Madame, Monsieur,',
      '',
      'Par la présente, j’exprime mon soutien au développement de **OnScen**, application dédiée à la visibilité des artistes et à la dynamisation de la vie musicale sur un territoire.',
      '',
      ...
      '',
      'OnScen propose une approche **centrée sur la musique et le terrain**, sans se substituer aux institutions culturelles, mais en complétant l’action des salles, des festivals et des médias locaux. Cette orientation correspond aux enjeux de **démocratisation de l’accès à la scène** que nous défendons.',
      '',
  ...
  },
  {
    ...
    lines: [
      '**Re :** Letter of support — OnScen platform',
      '',
      'To whom it may concern,',
      '',
      'I am writing in my capacity as **[manager / booking agent / independent artist with self-managed career]** to endorse **OnScen**, a music-focused social platform designed to improve **discoverability, local audience building, and live promotion**.',
      '',
      'The current digital landscape forces artists to spread efforts across generic social networks that **do not optimize for music discovery or event attendance**. OnScen addresses a clear gap: **geo-aware visibility**, integrated live experiences, and community features aligned with how fans actually engage with music today.',
      '',
      'From a professional standpoint, tools that **reduce friction between creation, promotion, and live performance** directly support sustainable careers — especially for emerging and mid-level acts. I consider OnScen a relevant innovation in that space and **support its development and deployment**.',
      '',
  ...
  },
  {
    ...
    lines: [
      '**Soutien à OnScen — une phrase :** les artistes ont besoin d’un outil **musique-first** pour être vus, bookés et écoutés ; OnScen le construit.',
      '',
      ...
      '3. **OnScen** = carte + communauté + lives + contenus → **boucle complète** pour un indépendant.',
      '',
  ...
  },
  {
    ...
    lines: [
      '**Objet :** Soutien au projet numérique OnScen — enjeux de filière musicale',
      '',
      'Madame, Monsieur,',
      '',
      ...
      '',
      'Le projet **OnScen** s’inscrit dans une logique de **plateforme sectorielle** : fonctionnalités de géolocalisation, de diffusion live, de partage de contenus musicaux et de mise en relation entre publics et créateurs. Une telle approche répond à un **besoin documenté** de diversification des outils de promotion, en complément des dispositifs publics (DRAC, SACEM, collectivités) et des acteurs privés.',
      '',
      'En ma qualité d’**artiste et acteur de la filière**, j’appuie l’initiative OnScen et considère qu’elle contribue, à terme, à **renforcer l’employabilité artistique** et la visibilité des scènes de proximité.',
      '',
      'Respectueusement,',
      '',
      '[Nom, prénom]',
  ...
  },
  {
    ...
    lines: [
      '**Je soutiens OnScen.**',
      '',
      'Artiste [genre / ville], j’en ai marre des apps où ma musique noie dans le bruit. **OnScen = musique + carte + live + communauté.** C’est exactement ce qu’il manque pour **passer du studio à la scène** sans budget pub.',
      '',
      'getsoundy.com',
      '',
      '[Pseudo / nom] · [Date]',
  ...
  },
  {
    ...
    subtitle: 'Communauté',
    lines: [
      'Chers membres du jury, chère équipe OnScen,',
      '',
      ...
      '',
      '**OnScen** me redonne de l’espoir — pas parce que c’est magique, mais parce que **tout est pensé pour nous**, les artistes de tous horizons. Peu importe que vous fassiez du rap, de la chanson, de l’électro ou du jazz : **vous avez une place sur la carte**, vous pouvez **montrer un live**, **rejoindre un salon**, **toucher des gens qui aiment déjà ce que vous aimez**.',
      '',
      'Je signe cette lettre avec conviction : **je soutiens OnScen** pour moi et pour tous ceux qui n’ont pas encore eu leur soirée.',
      '',
      'Avec gratitude,',
      '',
      '[Votre nom]',
  ...
  },
  {
    ...
    lines: [
      '**Objet :** Soutien de [Nom de l’association / collectif] au projet OnScen',
      '',
      'L’association **[nom]**, qui fédère des artistes et des acteurs culturels autour de **[musique live / scène locale / …]**, se prononce favorablement en faveur du projet **OnScen**.',
      '',
      'Nos adhérents — **artistes de genres et de niveaux variés** — partagent un besoin commun : **outils numériques adaptés à la promotion musicale** et à la mise en relation avec le public. OnScen répond à cette attente par une plateforme intégrant carte, contenus, lives et espaces d’échange, accessible via getsoundy.com.',
      '',
  ...
  },
  {
    ...
    lines: [
      '**OnScen mérite qu’on s’y arrête** — rarement une app française a aussi clairement choisi son camp : **la musique live et les artistes**, pas la viralité vide.',
      '',
      ...
      '',
      'Les défis restent ceux de toute jeune plateforme (adoption, modération, monétisation équitable), mais **la direction est la bonne**. Je soutiens OnScen et recommande aux décideurs de **l’accompagner** dans une phase où la scène indépendante a besoin d’alternatives crédibles aux géants généralistes.',
      '',
      '[Nom]',
      'Artiste · [ville] · [date]',
    ],
