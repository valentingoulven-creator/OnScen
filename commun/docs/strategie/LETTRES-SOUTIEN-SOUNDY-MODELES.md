# Lettres de soutien — Soundy (modèles)

**Usage :** modèles indicatifs à adapter (signature, ville, date, parcours). Chaque texte peut être signé par un **artiste**, un **professionnel de la culture** ou un **partenaire** ; ils restent valables quel que soit le genre musical ou le statut (amateur, semi-pro, auteur-compositeur, DJ, groupe, etc.).

**Produit :** Soundy · [getsoundy.com](https://getsoundy.com) — réseau social autour de la musique (carte, lives, salons, reels, visibilité locale → internationale).

> Remplacer les crochets `[…]` avant envoi. Longueur indicative : ½ à 1 page.

**Fichiers Word :** [`lettres-soutien/`](./lettres-soutien/) (10 × `.docx`) — régénération : `npm run lettres-soutien --prefix commun/docs/strategie`.

---

## 1. Registre institutionnel (collectivité / structure culturelle)
...
## 2. Registre convivial (artiste à artiste)
...
## 3. Registre professionnel (manager / booker / industrie)
...
## 4. Registre poétique / artistique
...
## 5. Registre direct / entrepreneurial
...
## 6. Registre académique / politique culturelle
...
## 7. Registre court / réseaux sociaux (à développer si besoin)
...
*(Version longue : ajouter 1 paragraphe sur votre parcours et 1 exemple concret — live, salon, date locale.)*

---

## 8. Registre émotionnel / communauté
...
## 9. Registre associatif (président·e d’asso / collectif)
...
## 10. Registre journalistique / critique
...
| Élément | Conseil |
|--------|---------|
| **Authenticité** | Ajouter 2–3 phrases personnelles (ville, genre, type de dates). |
| **Cohérence** | Ne pas promettre de chiffres d’audience ou de revenus non vérifiés. |
| **Signature** | Manuscrite ou PDF signé si le dossier l’exige (BIC, concours, partenaires). |
| **Doublons** | Ne pas envoyer dix fois le même registre au même organisme — varier les signataires **et** le ton. |

*Soundy · Modèles internes · juillet 2026 — non contractuels*
