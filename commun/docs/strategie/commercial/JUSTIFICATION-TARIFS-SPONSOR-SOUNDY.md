# Justification des tarifs sponsoring Soundy

**Document interne — Soundy (getsoundy.com)**  
...
**Sources techniques :** [`commun/docs/INFRA-SOUNDY.md`](../../INFRA-SOUNDY.md) · [`commun/docs/STACK-CIBLE.md`](../../STACK-CIBLE.md) · grille commerciale [`MODELE-DEVIS-SPONSOR.md`](./MODELE-DEVIS-SPONSOR.md).
...
|-----------|----------------|
| Structure | Entrepreneur individuel · éditeur Soundy (SIREN 106548464) |
...
| Pack | Prix HT / semaine | Somme unitaire | Remise annonceur | Intérêt Soundy |
|------|-------------------|----------------|------------------|----------------|
...
En phase sans audience mesurable, Soundy **ne facture pas au CPM**. Le benchmark sert uniquement à vérifier que le forfait **n’est pas « trop cher »** pour un annonceur local :
...
| **Soundy forfait** | Pas de CPM | **99 – 149 € / emplacement / semaine** |
...
| Infra streaming explose (lives) | Sponsors **ne financent pas seuls** les lives · abonnements / pourboires · plafonds Soundy+ |
...
*Document interne Soundy · getsoundy.com · À joindre au dossier BIC / pitch partenaires sur demande.*
