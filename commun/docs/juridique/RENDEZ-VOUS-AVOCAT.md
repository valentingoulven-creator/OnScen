# Fiche rendez-vous avocat (1 page)

**Date du RDV :** _______________  
**Avocat :** _______________  
**Objet :** conformité juridique de l’application mobile / web (nom commercial et domaine **à finaliser**)
...
| **3** | La plateforme est-elle **hébergeur** ou **éditeur** (LCEN / DSA) compte tenu de la modération admin, des algorithmes de feed et des sponsors ? |
...
| # | Question |
|---|----------|
| **12** | **DSA** : la plateforme est-elle concernée ? Obligations de signalement, transparence modération, contact légal ? |
...
| # | Question |
|---|----------|
| **15** | **Si l’application lance demain** avec pourboires réels + app iOS : quels sont les **3 risques** qui peuvent entraîner fermeture, rejet stores ou sanction — et **dans quel ordre** les traiter ? |
...
*Fiche interne — validation juridique — `commun/docs/juridique/RENDEZ-VOUS-AVOCAT.md`*
