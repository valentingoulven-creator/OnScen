...
- *Speaker notes : Accroche en 10 s — « OnScen réunit ce que les fans dispersent entre TikTok, Spotify et Shotgun, dans une seule app pensée pour la musique. »*
...
- **Actualités + Stories + Reels** — feed social, algo OnScen, reels sponsorisés (1/5 par défaut)
...
- **OnScen+** — abonnement plateforme 2,99–4,99 €/mois (badge, filtres carte, moins de sponsors)
- **B2B lieux** *(roadmap M7–M9)* — OnScen Pro Lieu 49–149 €/mois
- Répartition cible M24 *(hyp.)* : sponsors 45–55 % · commissions 25–35 % · OnScen+ 10–15 % · B2B 5–15 %
...
- **M4–M12** — Densité : playbooks Paris + Lyon/Marseille, 5 lieux/ville, challenges reels #OnScenReel, 5–8 contrats sponsors récurrents
- **M13–M24** — Monétisation : OnScen Pro Lieu (10–30 établissements), sales marques, expansion diaspora
...
| Acteur | Limite vs. OnScen | Position OnScen |
|--------|-------------------|-----------------|
...
- *Speaker notes : OnScen ne remplace pas Spotify — il socialise l'écoute et l'événementiel.*
