"""Generate Soundy presentation (non-technical, French) — sponsors, lieux, créateurs."""
...
OUTPUT = Path(__file__).resolve().parent / "Soundy-Presentation.pptx"
...
# Dark music-app palette (aligné UI Soundy)
...
SLIDES = [
    ...
    },
    {
        ...
        "footer": "Soundy reconnecte écoute sociale, carte et événements",
    },
    {
        "title": "La solution",
        "highlight": "Soundy est le réseau social qui fait écouter la même musique au même moment — sur une carte géolocalisée, en salon d'écoute ou en live vidéo.",
        "image": "02-carte.png",
        "image_layout": "right",
    ...
    },
    {
        ...
        "bullets": [
            ...
            "Stripe Connect opérationnel · Soundy+ (soutien plateforme)",
    ...
    },
    {
        ...
        "bullets": [
            ...
            "Soundy : où la musique devient un moment partagé — en ligne et sur place",
        ],
    ...
    },
    {
        ...
        "bullets": [
            "Tester Soundy : getsoundy.com (web ou app)",
