#!/usr/bin/env node
// seed_onscen_server.js
// À exécuter DIRECTEMENT sur le serveur production :
//   node /tmp/seed_onscen_server.js
//
...
const STORE = '/opt/onscen/data/store.json';
...
console.log('  OnScen Production Seeder (Node.js on-server)');
console.log('='.repeat(60));
...
console.log('\n⚡  Relance pm2 : pm2 restart onscen-backend');
