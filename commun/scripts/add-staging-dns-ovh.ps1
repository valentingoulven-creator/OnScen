# commun/scripts/add-staging-dns-ovh.ps1 - Add staging.getsoundy.com A record via OVH API
# Usage:
#   powershell -ExecutionPolicy Bypass -File commun/scripts/add-staging-dns-ovh.ps1
#   powershell -ExecutionPolicy Bypass -File commun/scripts/add-staging-dns-ovh.ps1 -VerifyOnly
#
# Credentials (one of):
#   commun/msdev/.env  -> OVH_APPLICATION_KEY, OVH_APPLICATION_SECRET, OVH_CONSUMER_KEY
