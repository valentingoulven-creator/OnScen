...
# Requires Stripe CLI (winget install Stripe.StripeCli) and commun/msdev/.env STRIPE_SECRET_KEY.
# Usage: powershell -ExecutionPolicy Bypass -File commun/scripts/stripe-listen-msdev.ps1
...
Write-Host 'Webhook secret : voir STRIPE_WEBHOOK_SECRET dans commun/msdev/.env (stripe listen --print-secret).' -ForegroundColor DarkGray
