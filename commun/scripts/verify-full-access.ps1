...
Add-Check 'commun/msdev/.env' (Test-Path (Join-Path $root 'commun\msdev\.env')) ''
Add-Check 'backend/.env.production' (Test-Path (Join-Path $root 'commun/backend\.env.production')) ''
Add-Check 'backend/.env.preproduction' (Test-Path (Join-Path $root 'commun/backend\.env.preproduction')) 'commun/scripts/setup-staging-env.ps1'
...
# Secrets dev
$msdev = Join-Path $root 'commun\msdev\.env'
...
Add-Check 'scw config' (Test-Path (Join-Path $env:USERPROFILE '.config\scw\config.yaml')) 'commun/scripts/setup-scw.ps1'
