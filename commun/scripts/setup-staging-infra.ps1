# commun/scripts/setup-staging-infra.ps1 — Bootstrap VPS staging + base PG + SSH config
# Usage : powershell -ExecutionPolicy Bypass -File commun/scripts/setup-staging-infra.ps1
param(
...
Write-Host 'Puis : commun/scripts/setup-staging-env.ps1 && commun/scripts/deploy-preprod.ps1' -ForegroundColor Cyan
