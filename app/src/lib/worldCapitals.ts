/**
 * Sovereign-state capitals with precise city-center coordinates.
 * Includes UN member states, observers (Vatican, Palestine), and widely
 * recognized states (Taiwan, Kosovo).
 */
...
/** All sovereign capitals — sorted alphabetically by country. */
export const WORLD_CAPITALS: WorldCapital[] = [
  ...
  { name: "Saint John's", country: 'Antigua and Barbuda', lat: 17.1274, lng: -61.8468 },
  ...
  { name: 'Bridgetown', country: 'Barbados', lat: 13.0975, lng: -59.6167 },
  ...
  { name: 'Praia', country: 'Cabo Verde', lat: 14.9331, lng: -23.5133 },
  ...
  { name: 'Kinshasa', country: 'Congo (DRC)', lat: -4.4419, lng: 15.2663 },
  { name: 'Brazzaville', country: 'Congo (Republic)', lat: -4.2634, lng: 15.2429 },
  { name: 'San José', country: 'Costa Rica', lat: 9.9281, lng: -84.0907 },
  { name: 'Yamoussoukro', country: "Côte d'Ivoire", lat: 6.8276, lng: -5.2893 },
  ...
  { name: 'Roseau', country: 'Dominica', lat: 15.3010, lng: -61.3881 },
  ...
  { name: 'Tarawa', country: 'Kiribati', lat: 1.3291, lng: 172.9790 },
  ...
  { name: 'Palikir', country: 'Micronesia', lat: 6.9147, lng: 158.1610 },
  { name: 'Chișinău', country: 'Moldova', lat: 47.0105, lng: 28.8638 },
  ...
  { name: 'Sri Jayawardenepura Kotte', country: 'Sri Lanka', lat: 6.9105, lng: 79.8877 },
  ...
  { name: "Nuku'alofa", country: 'Tonga', lat: -21.1393, lng: -175.2040 },
  { name: 'Port of Spain', country: 'Trinidad and Tobago', lat: 10.6603, lng: -61.5086 },
...
/** Label payload for react-globe.gl `labelsData` — `text` is the UI label (capital name only). */
export interface GlobeCapitalLabel {
  lat: number;
  lng: number;
  text: string;
  /** Internal metadata; not shown in map/globe labels. */
  country: string;
}

export function toGlobeCapitalLabels(capitals: WorldCapital[] = WORLD_CAPITALS): GlobeCapitalLabel[] {
