...
export const licences: LegalDocument = {
  ...
  sections: [
    {
      heading: 'MeloSong',
      body: 'Application MeloSong — projet social autour de la musique géolocalisée. Code source et documentation : voir le dépôt du projet (licence à préciser par l’éditeur).',
    },
    {
    ...
    },
    {
      ...
      body: 'Interface MeloSong : polices système et ressources intégrées. Vérifier les licences de toute ressource graphique ajoutée ultérieurement.',
    },
  ],
};
