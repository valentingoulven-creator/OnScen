...
const defaultSrc = path.join(
  root,
  '../../.cursor/projects/c-Dev-Soundy/assets/c__Users_vivia_AppData_Roaming_Cursor_User_workspaceStorage_419acbc9cbd4685a40a517f5f5dcb476_images_image-f8ee09c1-4def-4878-9016-aa4af8637321.png'
);

const src = process.argv[2] ? path.resolve(process.argv[2]) : defaultSrc;

const targets = [
  path.join(root, 'public/soundy-logo.png'),
  path.join(root, '../../commun/backend/public/soundy-logo.png'),
];
