...
/** Bouton don spectateur — dégradé wave Soundy (purple → pink). */
export const LIVE_THEATER_DONATE_BTN_CLASS =
  'live-theater-chrome-btn--soundy-wave text-white border-purple-400/45 shadow-lg shadow-purple-900/45 hover:border-pink-300/55 hover:shadow-pink-900/35 ring-1 ring-inset ring-white/20 min-h-11 min-w-11 backdrop-blur-sm';
