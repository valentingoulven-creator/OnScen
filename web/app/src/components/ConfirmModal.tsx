...
export function ConfirmModal({
  ...
  const modal = (
    <div
      className="fixed inset-0 z-[110] flex items-end sm:items-center justify-center ms-modal-overlay bg-black/60 backdrop-blur-sm"
      role="dialog"
      aria-modal="true"
    ...
    >
      <div
        ref={focusTrapRef}
        tabIndex={-1}
        className="w-full max-w-sm bg-[#12121a] border border-[#2d2d3d] rounded-t-2xl sm:rounded-2xl ms-modal-panel shadow-2xl overflow-hidden max-h-[90dvh] outline-none pb-[env(safe-area-inset-bottom)]"
