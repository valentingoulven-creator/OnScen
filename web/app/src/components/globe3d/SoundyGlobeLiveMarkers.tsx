...
function liveFromGlobePoint(p: SoundyGlobePoint): Live | null {
...
function buildGlobeLiveMarkerHtml(p: SoundyGlobePoint, overviewDots: boolean): string {
...
export function SoundyGlobeLiveMarkers({
  points,
  overviewDots,
  onPointClick,
}: SoundyGlobeLiveMarkersProps) {
