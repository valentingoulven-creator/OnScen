...
export function GenreOnboardingPrompt({ onDismiss }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-end sm:items-center justify-center ms-modal-overlay bg-black/70 backdrop-blur-sm">
      <div className="w-full max-w-sm bg-[#12121a] border border-[#2d2d3d] rounded-2xl p-5 space-y-4 shadow-2xl max-h-[90dvh] overflow-y-auto">
