...
export const MAP_EVENTS_REFRESH_EVENT = 'onscen_map_events_refresh';

/** Recharge le carrousel Sponso sidebar carte (après promotion Dev sur EventCard). */
export const MAP_SIDEBAR_SPONSO_REFRESH_EVENT = 'onscen_map_sidebar_sponso_refresh';
...
export const REELS_SPONSO_REFRESH_EVENT = 'onscen_reels_sponso_refresh';
