...
| **PM2 cluster** `instances: max`, `exec_mode: cluster` | `deploy/ecosystem.config.cjs` + Caddy sticky sessions | 1 j |
...
| PM2 prod | `deploy/ecosystem.config.cjs` |
