...
Pour recréer un compte : `powershell -ExecutionPolicy Bypass -File scripts/create-youtube-audit-demo-account.ps1`
...
powershell -ExecutionPolicy Bypass -File scripts/prepare-youtube-audit-demo.ps1
```
