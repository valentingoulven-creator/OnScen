 ...
 *     PM2["PM2 melosong-backend · max 512M"]
...
const PLATFORM_PLAN_ROWS: [string, string, string][] = [
  ...
  ["Soundy+ (9,99 €/mo)", "400 spectateurs · 4 h/j", "LiveKit · pas OBS/CF"],
  ["SoundyUltra (19,99 €/mo)", "Illimité", "LiveKit + OBS Cloudflare"],
];
...
export default function InfraSoundyCanvas() {
  const theme = useHostTheme();
    ...
    <Stack gap={20} style={{ padding: "4px 0 40px", maxWidth: 980 }}>
      ...
      <Stack gap={6}>
        ...
        <Text style={{ color: theme.text.secondary }}>
          Architecture production Soundy —{" "}
      ...
      <Stack gap={8}>
        ...
        <DagDiagram
          ...
          edges={ARCH_EDGES}
          direction="vertical"
          caption={`Source : docs/COUT-APPLICATION.md · deploy/README.md · ${META.updated}`}
          height={560}
        />
      </Stack>
      ...
      <Stack gap={8}>
        ...
        <Table headers={["Service", "Limites / modèle", "Rôle Soundy"]} rows={EXTERNAL_ROWS} />
        <Card size="sm">
        ...
        <CardBody>
          ...
          <Stack gap={4}>
            <Text style={{ fontSize: 12, color: theme.text.secondary }}>
              docs/COUT-APPLICATION.md · deploy/RUNBOOK-PROD.md · deploy/ecosystem.config.cjs ·
