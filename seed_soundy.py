...
sur le serveur production Soundy (51.159.164.100).

Usage (depuis PowerShell ou cmd) :
    python seed_soundy.py
"""
...
STORE    = "/opt/soundly/data/store.json"
PM2_NAME = "melosong-backend"
...
BOTS = [
    dict(
        ...
        track_id="2P91MQbaiQKBR4c9sEgqsl",
    ...
    dict(
        ...
        track_id="spotify:track:soWhat_jazz",
    ...
    dict(
        ...
        track_id="spotify:track:dna_kendrick",
    ...
    dict(
        ...
        track_id="spotify:track:mrbrightside",
...
def main():
    print("=" * 60)
    print("  Soundy Production Seeder")
    print("=" * 60)
