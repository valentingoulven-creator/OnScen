...
if (fs.existsSync(envSrc)) {
  ...
  console.warn('msdev/.env absent — copie de .env.example vers release/.env');

  fs.copyFileSync(envExample, path.join(releaseDir, '.env'));

} else {

  throw new Error('msdev/.env ou msdev/.env.example requis pour le build exe');
...
Voir : DEBLOCAGE-WINDOWS.txt, msdev/BUILD-EXE.txt, msdev/MOBILE-PWA.txt
