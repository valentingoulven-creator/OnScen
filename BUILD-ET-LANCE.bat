...
echo.
echo  ============================================================
echo    MeloSong - Build Production + Tunnel ngrok
echo  ============================================================
echo.

:: -- 1. Build frontend -------------------------------------------
echo  [1/5] Build du frontend (app/)...
echo         (minification, code splitting, PWA, vers backend/public/)
echo.
...
cd /d "%~dp0"
echo.
echo  [OK] Build termine. Assets dans backend/public/assets/
echo.
