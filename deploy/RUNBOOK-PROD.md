...
# [soundly] DATABASE_URL absent â€” repli sur store.json local ...
```
...
Fichier : `deploy/ecosystem.config.cjs` â€” `autorestart`, `max_memory_restart: 512M`, logs dans `/opt/soundly/logs/`.
