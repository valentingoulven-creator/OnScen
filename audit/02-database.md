...
| Rôle DB | Audit antérieur : rôle applicatif sur-privilégié (`CREATEROLE`) | **élevé** | `REVOKE` après validation DBA |

---

## 2.7 Synthèse phase 2

Actions prioritaires : **test restauration backup**, **PostGIS + couverture geom**, **réduction store RAM**, **privilèges DB least-privilege**.
